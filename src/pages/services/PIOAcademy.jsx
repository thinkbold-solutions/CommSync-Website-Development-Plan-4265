...
const PIOAcademy = () => {
  return (
    <>
      <Helmet>
        <title>The PIO Academy - CommSync | FEMA-Certified Training Programs</title>
        <meta name="description" content="Elite FEMA-certified PIO training programs for public information officers and communication professionals. Join the premier crisis communication training academy." />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-montserrat font-bold mb-6">
                The <span className="gradient-text">PIO Academy</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="https://members.pio.training"
                  target="_blank"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-3xl font-montserrat font-bold text-primary-charcoal mb-6">
                  Join the Elite PIO Community
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Beyond training, The PIO Academy offers exclusive access to a community of crisis communication professionals, ongoing education, and career advancement opportunities.
                </p>
                <div className="space-y-4 mb-8">
        ...
        <section className="py-20 bg-primary-blue text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 leading-relaxed">
              Join thousands of professionals who have elevated their crisis communication skills through The PIO Academy.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
